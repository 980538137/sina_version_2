...
public class SimpleImageLoader {
	...
	public static void showImg(final ImageView imageView, String imgURL,
		...
		AsyncImageLoader mAsyncImageLoader = WeiboApplication.mAsyncImageLoader;
		imageView.setTag(imgURL);
		Bitmap bitmap = mAsyncImageLoader.get(imgURL,new ImageCallback() {
	...
	public static void showWbContentImg(final ImageView imageView,
		...
		AsyncImageLoader mAsyncImageLoader = WeiboApplication.mAsyncImageLoader;
		imageView.setTag(imgURL);
		Bitmap bitmap = mAsyncImageLoader.get(imgURL,
				new ImageCallback() {
